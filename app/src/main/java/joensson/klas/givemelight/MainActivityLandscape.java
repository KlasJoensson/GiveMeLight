...
public class MainActivityLandscape extends ActionBarActivity {
    ...
    private void createFlashErrorDialog() {
        AlertDialog alert = new AlertDialog.Builder(MainActivityLandscape.this).create();
    ...
    private View.OnClickListener openLightBoardListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent showLBIntent = new Intent(MainActivityLandscape.this, LightBoard.class);
